...
function richerrecruitment_preprocess_html(&$variables) {
	...
	drupal_add_js(drupal_get_path('theme', 'richerrecruitment'). '/js/slider.js', $options);
  ...
  if (!empty($variables['page']['course_overview_preschool'])){
    $variables['classes_array'][] = 'course_overview_preschool';
  }
  
  if (!empty($variables['page']['course_overview_prischool'])){
    $variables['classes_array'][] = 'course_overview_prischool';
  }
  
  if (!empty($variables['page']['course_overview_teen'])){
    $variables['classes_array'][] = 'course_overview_teen';
  }
